...
int MDP::next_state_adversarial(int s_id, const Action &a,
                                const std::vector<PieceType> &adv_policy,
                                double &reward) const
{
    SAKey key{s_id, a};
    const Transition &tr = transitions.at(key);
...
EvalStats MDP::evaluate_minimax_strategies(const std::vector<Action> &player_policy,
                                           const std::vector<PieceType> &adv_policy,
                                           int episodes,
                                           int max_steps) const
{
...
std::vector<int> MDP::rollout_adversarial_states(const std::vector<Action> &player_policy,
                                                 const std::vector<PieceType> &adv_policy,
                                                 int max_steps) const
{
    std::vector<int> empty_board(H, 0);
